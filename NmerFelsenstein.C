...
// -----------------------------------------------------------------
// class NMER_Likelihooder
// -----------------------------------------------------------------

struct NMER_Likelihooder : public HOG_Likelihooder
{
  int order;
  NmerRateMatrix *Q;
  BitSet gapSymbols;
...
public:
  NMER_Likelihooder(int numNodes,int numAlpha,Alphabet &alpha,
...
// -----------------------------------------------------------------
// class NmerFelsenstein
// -----------------------------------------------------------------

NmerFelsenstein::NmerFelsenstein(Phylogeny &phylogeny,
				 NmerRateMatrix *Q,
				 MultSeqAlignment &A,
...
HOG_Likelihooder *NmerFelsenstein::getLikelihooder(int numNodes,int numAlpha,
		    ...
		    AlphabetMap &alphabetMap,MolecularSequenceType seqType)
{
  ...
  return new NMER_Likelihooder(numNodes,numAlpha,alpha,A,firstCol,lastCol,
